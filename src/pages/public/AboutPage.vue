<template>
  <PublicLayout>
    <div class="relative min-h-screen pb-10">
      <KyrgyzOrnamentPattern :opacity="0.06" :scale="1.4" class="fixed inset-0 z-0 pointer-events-none mix-blend-overlay" />

      <section class="relative z-10 mx-auto max-w-7xl px-6 py-14 lg:py-20">
