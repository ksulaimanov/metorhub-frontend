    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 py-8">
      <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="mt-1 text-sm text-text-secondary">Manage registered users, their roles, and access.</p>
        </div>
        <div class="flex items-center gap-3">
          <div class="relative w-full sm:w-72">
            ...
            <input
              ...
              class="w-full rounded-xl border border-border-subtle bg-surface py-2 pl-9 pr-4 text-sm outline-none focus:border-brand focus:ring-1 focus:ring-brand"
              v-model="searchQuery"
              @input="onSearch"
            />
          </div>
      ...
      <div class="grid gap-4">
        ...
        <AppCard v-for="user in users" :key="user.id" class=" bg-surface/80 hover:shadow-md transition-all">
