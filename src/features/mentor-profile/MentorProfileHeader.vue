      ...
      <div class="flex items-center gap-5">
        ...
        <div class="min-w-0">
          <div class="flex items-center gap-2">
            ...
            <span v-if="username" class="rounded-lg bg-surface border border-white/10 shadow-md-secondary px-2 py-0.5 text-xs font-semibold tracking-wide text-brand/80">
              @{{ username }}
            </span>
          </div>
