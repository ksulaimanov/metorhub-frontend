    ...
    <div v-else class="space-y-4">
      ...
      <div class="grid gap-3 text-sm">
        <div class="rounded-2xl bg-brand-soft/40 p-4 ring-1 ring-border-brand/60">
          <p class="font-medium text-white">{{ t('mentorApplication.statusSubmittedAt') }}</p>
          <p class="mt-1 text-slate-400">{{ formatDate(statusData.submittedAt) }}</p>
        </div>
        ...
        <div v-if="statusData.reviewedAt" class="rounded-2xl bg-brand-soft/40 p-4 ring-1 ring-border-brand/60">
          ...
          <p class="mt-1 text-slate-400">{{ formatDate(statusData.reviewedAt) }}</p>
        </div>
