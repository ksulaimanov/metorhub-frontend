<template>
  <div class="rounded-2xl bg-surface border border-white/10 shadow-md p-5 ring-1 ring-border-brand/80">
    ...
    <p v-if="review.comment" class="mt-3 text-sm leading-relaxed text-text-secondary">
      {{ review.comment }}
    </p>
  </div>
</template>
